...
function Ask() {
  ...
  const postQuestion = async (e) => {
    titleDom.current.classList.remove("bg-red-200");
    descriptionDom.current.classList.remove("bg-red-200");
    ...
    <div className="bg-gray-200 py-24 px-24">
      ...
      <div className="ask mt-5">
        ...
        <form onSubmit={postQuestion}>
          <p className="text-success text-green-600 text-center text-2xl">{msg}</p>
          ...
          <div className="w-75 mx-auto mt-2">
            <button
              disabled={loading}
              className="btn btn-primary bg-blue-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded"
            >
              Post Question
            </button>
          </div>
